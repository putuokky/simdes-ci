  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form role="form" method="post" action="<?=site_url('referensi/agama/tambah_aksi') ?>">
            <!-- text input -->
            ...
            <div class="form-group">
              <label>Agama</label>
              <input type="text" class="form-control" placeholder="Masukkan Data" name="agama" required="">
            </div>
